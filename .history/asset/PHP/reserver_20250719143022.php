...
error_log('PLACES reçues dans reserver.php : ' . $places);
...
try {
    $pdo = new PDO( $pdo = new PDO("mysql:host=sql309.infinityfree.com;dbname=$dbname;charset=utf8", $username, $password);
