...
if (isset($_GET['all']) && $_GET['all'] === '1') {
    try {
        ...
        if (!empty($_GET['note_min'])) {
            // Il faut filtrer les conducteurs avec note >= note_min
            // Supposons qu'il y ait une table `notes` avec colonnes: conducteur_id, note (float)
            // On calcule la moyenne des notes par conducteur et on filtre ici
            $where[] = "(
