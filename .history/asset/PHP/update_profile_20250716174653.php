...
// Vérifier la confirmation du mot de passe pour modification sensible
if (!isset($_POST['passwordConfirm']) || empty($_POST['passwordConfirm'])) {
    echo json_encode(['error' => 'Le mot de passe de confirmation est obligatoire.']);
    exit;
}
...
try {
    ...
    // Récupérer le hash du mot de passe stocké pour l'utilisateur
    ...
    // 1. Mise à jour des infos de base (prenom, nom, email, bio)
