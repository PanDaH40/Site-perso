...
try {
    ...
    $stmt = $pdo->prepare('SELECT COUNT(*) FROM reservations WHERE trajet_id = ? AND passager_id = ? AND statut IN ("En attente", "Confirmé")');
    ...
    $stmtInsert->execute([$trajetId, $userId, $places, 'En attente']);
