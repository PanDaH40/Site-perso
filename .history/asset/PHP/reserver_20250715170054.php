...
try {
    ...
    if ($action === 'cancel') {
        ...
        // Récupérer total de places réservées pour ce trajet
        ...
        // Vérifier double réservation (on interdit plusieurs réservations sur le même trajet pour un même utilisateur)
