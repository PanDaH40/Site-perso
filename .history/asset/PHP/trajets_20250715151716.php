...
// 2) Récupération de l'ID de l'utilisateur (pour POST et dashboard)
$userId = $_SESSION['user']['id'] ?? null;

// ----------------------------------------------------------------
// A) POST (sans paramètre GET) : création d'un trajet
...
// ----------------------------------------------------------------
// C) Dashboard : trajets proposés et réservés (authentification requise)
if (!$userId) {
    http_response_code(401);
    echo json_encode(['error' => 'Utilisateur non connecté']);
    exit;
