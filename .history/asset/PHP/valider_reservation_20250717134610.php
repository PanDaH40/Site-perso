...
try {
    ...
    if ($action === 'accepter') {
    // Récupère le nombre de jetons du trajet
    ...
    // Vérifie crédits passager (2 crédits commission + jetons du trajet)
    ...
    // Déduit les crédits du passager (commission + jetons trajet)
    ...
    // Verse les jetons du trajet au conducteur
