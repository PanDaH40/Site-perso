...
// Vérifier la connexion de l'utilisateur courant
...
try {
    ...
    // Infos publiques du profil (avec marque et modèle du véhicule)
    $stmt = $pdo->prepare("
    SELECT 
        i.prenom, i.nom, i.avatar, i.bio,
        c.marque_vehicule, c.modele_vehicule, c.plaque, c.couleur, c.date_premiere_immatriculation, c.carburant,
...
");
    ...
    // Si connecté, infos pour le formulaire d'avis (déjà noté ?)
