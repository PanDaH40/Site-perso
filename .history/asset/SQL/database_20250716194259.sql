...
ALTER TABLE reservations
ADD CONSTRAINT fk_trajet FOREIGN KEY (trajet_id) REFERENCES trajets(id) ON DELETE CASCADE,
ADD CONSTRAINT fk_passager FOREIGN KEY (passager_id) REFERENCES inscrits(id) ON DELETE CASCADE;
