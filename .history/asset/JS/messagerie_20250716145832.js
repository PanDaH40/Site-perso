    ...
    fetch('asset/PHP/get_messages_recus.php')
      ...
      .then(data => {
        ...
        data.conversations.forEach(conv => {
          // On filtre pour ne garder que les conversations où l'utilisateur a reçu des messages (badge > 0)
          // Si tu veux TOUS les interlocuteurs qui ont déjà envoyé au moins un message, cette condition est suffisante.
          if (conv.badge > 0 || conv.badge === 0) { // Garde tous, badge = non lus, badge=0 = lu
