document.addEventListener("DOMContentLoaded", () => {
  ...
  // *** Affichage filtré des trajets seulement après recherche ***
  if (form) {
  ...
  // Affiche la liste des trajets filtrés
  ...
  // Par défaut, aucun trajet n'est affiché à l'ouverture de la page
  let liste = document.getElementById("liste-trajets");
  if (liste) liste.innerHTML = '';
});
