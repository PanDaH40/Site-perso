...
function afficherTrajets(trajets) {
    ...
    trajets.forEach(trajet => {
        // Lien vers profil conducteur (assure-toi que conducteur_id est bien dans le JSON)
        ...
        // Affichage avec la précision du lieu (si disponible)
        col.innerHTML = `
            <div class="card h-100 shadow-sm">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <a href="Profile.html?id=${conducteurId}" title="Voir le profil du conducteur">
