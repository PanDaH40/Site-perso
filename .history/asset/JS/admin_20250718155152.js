document.addEventListener("DOMContentLoaded", () => {
  ...
  // -- Fonctions utilisateurs existantes (adminToggleStatut, adminResetPwd, adminSetPwd, adminEditRole, adminEditJetons) --
  // (Je ne les remets pas ici pour éviter trop de répétitions, elles restent inchangées)
