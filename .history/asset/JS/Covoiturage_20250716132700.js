...
// ----------- UTILITAIRE AVATAR -----------
function setAvatarSrc(avatarPath) {
...
function afficherTrajets(trajets) {
    ...
    trajets.forEach(trajet => {
        // Correction : utiliser le chemin BDD ou l’avatar par défaut
        const conducteurId = trajet.conducteur_id || "";
        const imgSrc = setAvatarSrc(trajet.conducteur_avatar);
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <a href="ProfilePublic.html?id=${conducteurId}" title="Voir le profil du conducteur">
                            <img src="${imgSrc}" alt="Photo du conducteur" class="rounded-circle border me-3" style="width:48px; height:48px; object-fit:cover; cursor:pointer;" onerror="this.src='asset/Images/default_03.png'">
                        </a>
                        <div>
