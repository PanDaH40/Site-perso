document.addEventListener('DOMContentLoaded', () => {
  ...
  // Création champ mot de passe confirmation (caché initialement)
  ...
  // Clic sur avatar = ouvrir sélection fichier
  ...
  // Affiche le champ mot de passe dès qu'on modifie prénom, nom ou email
  ...
  // Soumission formulaire avec validation mot de passe confirmation si visible
