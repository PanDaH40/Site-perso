...
function afficherTrajetsProposes(trajets) {
  const tbody = document.querySelector('#trajets-proposes tbody');
  tbody.innerHTML = '';
...
function afficherTrajetsReserves(trajets) {
  const tbody = document.querySelector('#trajets-reserves tbody');
  tbody.innerHTML = '';
...
function renderConducteurCell(trajet) {
  return `
    <div class="conductor-info">
      <img src="asset/Images/${trajet.conducteur_avatar || 'default_03.png'}" 
           class="conductor-avatar me-2" alt="">
