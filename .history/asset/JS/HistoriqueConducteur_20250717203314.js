    ...
    .then(data => {
      ...
      infoConducteurEl.innerHTML = `
        <div class="d-flex align-items-center mb-2">
          <img src="${data.avatar || 'asset/Images/default_03.png'}" alt="Photo" class="rounded-circle me-3" style="width:56px;height:56px;object-fit:cover;">
          <div>
  ...
  fetch(`asset/PHP/historique_conducteur.php?id=${encodeURIComponent(conducteurId)}`)
    ...
    .then(data => {
      ...
      data.trajets.forEach(trajet => {
        ...
        card.className = 'card trajet-card';
        card.innerHTML = `
          <div class="card-body">
            <div class="row">
