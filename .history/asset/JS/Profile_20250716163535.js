document.addEventListener('DOMContentLoaded', () => {
  ...
  const notifBadge       = document.getElementById('notif-badge');  // badge notification
  ...
  async function loadProfile() {
    try {
      ...
      // Mise à jour badge notifications messages après chargement profil
  ...
  if (form) form.addEventListener('submit', async e => {
    ...
    try {
      ...
      if (result.error) {
        ...
        // Optionnel : recharger le profil si besoin
        // await loadProfile();
      }
    } catch (err) {
