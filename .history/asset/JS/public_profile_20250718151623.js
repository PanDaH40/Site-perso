document.addEventListener('DOMContentLoaded', () => {  
  ...
  fetch(`asset/PHP/get_public_profile.php?id=${encodeURIComponent(userId)}`)
    ...
    .then(data => {
      ...
      // Mise à jour profil (avatar, pseudo, bio, etc.)
      ...
      // Rôle, ancienneté, infos
      roleEl.textContent = data.roleConducteur ? (data.rolePassager ? 'Conducteur & Passager' : 'Conducteur') :
                         data.rolePassager ? 'Passager' : 'Membre';
