document.addEventListener("DOMContentLoaded", () => {
  ...
  // === FONCTION DÉCLENCHEMENT AUTO SI PARAMÈTRES DANS L’URL ===
  const params = getUrlParams();
  if (params.depart && params.arrivee && params.date) {
    if (document.getElementById("searchDepart")) document.getElementById("searchDepart").value = params.depart;
    if (document.getElementById("searchArrivee")) document.getElementById("searchArrivee").value = params.arrivee;
    if (document.getElementById("searchDate")) document.getElementById("searchDate").value = params.date;
    if (params.places && document.getElementById("searchPlaces")) document.getElementById("searchPlaces").value = params.places;
    rechercherTrajets();
  }
