document.addEventListener('DOMContentLoaded', () => {
  ...
  // Nouveaux champs pour la gestion véhicule conducteur :
  const marqueVehiculeInput = $('profileMarqueVehicule');   // Ajoute ce champ dans le HTML
  const modeleVehiculeInput = $('profileModeleVehicule');   // Ajoute ce champ dans le HTML
  ...
  async function loadProfile() {
    try {
      ...
      // --- Ajout pour les nouveaux champs véhicule conducteur :
  ...
  if (form) {
    form.addEventListener('submit', async e => {
      ...
      if (roleCondCheckbox && roleCondCheckbox.checked) {
        ...
        // --- Ajout des champs véhicule conducteur :
