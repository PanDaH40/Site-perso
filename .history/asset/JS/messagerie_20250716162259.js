document.addEventListener('DOMContentLoaded', () => {
  ...
  const notifBadge = document.getElementById('notif-badge');  // <== Utilise notif-badge ici
  ...
  function chargerConversations() {
    fetch('asset/PHP/get_messages_recus.php')
      ...
      .then(data => {
        ...
        const totalNonLus = data.totalNonLus || 0; // total venant de PHP
        ...
        // Mise à jour du badge de la cloche
        if (notifBadge) {
