document.addEventListener('DOMContentLoaded', () => {
  ...
  // Garde trace si nom/prénom/email modifié pour afficher mot de passe
  ...
  if(btnTogglePwd && changePwdFields) {
    btnTogglePwd.addEventListener('click', () => {
      if (changePwdFields.style.display === 'none' || changePwdFields.style.display === '') {
        ...
        if(passwordConfirmCurrent) passwordConfirmCurrent.required = true;
      } else {
        changePwdFields.style.display = 'none';
        if(passwordConfirmCurrent) passwordConfirmCurrent.required = false;
  ...
  if (form) form.addEventListener('submit', async e => {
    ...
    if (changePwdFields && changePwdFields.style.display === 'block' && passwordConfirmCurrent && passwordConfirmCurrent.value.trim() === '') {
    ...
    if (changePwdFields && changePwdFields.style.display === 'block' && 
        (newPasswordInput && newPasswordInput.value.trim() !== '' || newPasswordConfirmInput && newPasswordConfirmInput.value.trim() !== '')) {
