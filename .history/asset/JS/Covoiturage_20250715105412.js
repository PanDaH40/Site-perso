...
// Chemins d'accès définis pour le projet sous /TPCovoiturage/
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Chemins d'accès statiques pour le projet
  const API_BASE = '/TPCovoiturage/asset/PHP';
  const LOGIN_PAGE = '/TPCovoiturage/PageConnection.html';
  ...
  // Envoi POST pour création de trajet
  if (form) {
