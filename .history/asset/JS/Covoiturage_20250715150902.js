...
// Gestion de l'ajout, de l'affichage (profil conducteur inclus) et des réservations
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // 3) Génération des cartes de trajet
  function afficherTrajets(trajets) {
    ...
    // Cliquer sur l'avatar → profil
    document.querySelectorAll('.card-header img').forEach(img => {
      img.addEventListener('click', () => {
        const uid = img.dataset.conducteurId;
