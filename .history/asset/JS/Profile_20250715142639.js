...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function toggleRoleSections() {
    ...
    // Passager – on n'oblige plus preferences
    if (rolePassCheckbox.checked) {
      passagerFields.style.display = '';
    } else {
      passagerFields.style.display = 'none';
    }
    // On retire la contrainte required sur preferences quoi qu'il arrive
  ...
  form.addEventListener('submit', async e => {
    ...
    // Préférences passager envoyées seulement si présentes
