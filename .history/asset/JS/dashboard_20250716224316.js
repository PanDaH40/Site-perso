...
function afficherTrajetsReserves(trajets) {
  ...
  trajets.forEach(trajet => {
    ...
    trEl.innerHTML = `
      ...
      <td class="text-center actions-btns">
        <button class="btn btn-sm btn-outline-danger" title="Annuler la réservation" onclick="annulerReservation(${reservationId})">
...
function renderConducteurCell(trajet) {
  ...
  return `
    <div class="conductor-info d-flex align-items-center">
      <img src="${avatar}" alt="Avatar conducteur" class="conductor-avatar me-2" style="width:36px;height:36px;object
