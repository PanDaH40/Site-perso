...
// Gestion de l'ajout, de l'affichage des trajets (avec avatar) et des réservations
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // 3) Affichage des trajets avec avatar + nom
  ...
  console.log('Premier trajet pour debug :', trajets[0]);

  trajets.forEach(t => {
    // On enlève bien le total déjà réservé
