document.addEventListener('DOMContentLoaded', () => {
      ...
      .then(data => {
        ...
        data.conversations.forEach(conv => {
          ...
          li.onclick = () => {
            ...
            // Activer la zone d'envoi quand une conversation est sélectionnée
  ...
  // Initialisation
  // Désactive l’envoi tant qu’aucune conversation n’est sélectionnée
  if (messageTexte && sendBtn) {
    messageTexte.disabled = true;
    sendBtn.disabled = true;
  }
