...
function rechercherTrajets() {
  ...
  const prixMax = document.getElementById("searchJetonsMax")?.value.trim() || "";
  ...
  if (jetonsMax) url += '&jetons_max=' + encodeURIComponent(prixMax);
...
function ajouterTrajet() {
  ...
  const jetons = document.getElementById("prix")?.value.trim() || "";
